...
//
void EllipseTGraphRMM(TGraph *g = ((TGraph *)0))
{
  ...
  if ( m && (!(m->Status())) ) {
    ...
    double focus_x = xm[0]+sqrt((xm[2]*xm[2])-(xm[3]*xm[3]))*cos(xm[4]*3.1415/180);
    double focus_y = xm[1]+sqrt((xm[2]*xm[2])-(xm[3]*xm[3]))*sin(xm[4]*3.1415/180);

    cout << "focus x" << focus_x << endl;
    cout << "focus x" << focus_y << endl;
    //c->SaveAs("ell.png");
